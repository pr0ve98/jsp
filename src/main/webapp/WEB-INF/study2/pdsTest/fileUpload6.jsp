...
<head>
	...
	<script>
		...
		function fCheck() {
			...
			let ext = "";
			let fileSize = 0;
			let maxSize = 1024 * 1024 * 5 // 기본단위는 Byte, 1024 * 1024 * 10 = 10MB 허용
			...
			for(let i=0; i<fileLength; i++){
				...
				if(ext != 'jpg' && ext != 'png' &&ext != 'gif' &&ext != 'zip' &&ext != 'hwp' &&ext != 'ppt' &&ext != 'pptx' &&ext != 'jpeg' &&ext != 'doc' &&ext != 'pdf' &&ext != 'xlsx'&&ext != 'txt'){
...
<div class="container">
	...
	<p>자바 서블릿의 Part객체를 이용한 파일 업로드</p>
