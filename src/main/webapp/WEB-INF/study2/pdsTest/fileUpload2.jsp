...
<head>
	...
	<script>
		...
		function fCheck() {
			...
			else if(ext1 != 'jpg' && ext1 != 'png' &&ext1 != 'gif' &&ext1 != 'zip' &&ext1 != 'hwp' &&ext1 != 'ppt' &&ext1 != 'pptx' &&ext1 != 'jpeg' &&ext1 != 'doc' &&ext1 != 'pdf' &&ext1 != 'xlsx'&&ext1 != 'txt'){
				alert("업로드 가능한 파일은 jpg/jpeg/png/gif/zip/hwp/ppt/pptx/doc/pdf/xlsx/txt만 가능합니다");
			}
			else if(ext2 != 'jpg' && ext2 != 'png' &&ext2 != 'gif' &&ext2 != 'zip' &&ext2 != 'hwp' &&ext2 != 'ppt' &&ext2 != 'pptx' &&ext2 != 'jpeg' &&ext2 != 'doc' &&ext2 != 'pdf' &&ext2 != 'xlsx'&&ext2 != 'txt'){
				alert("업로드 가능한 파일은 jpg/jpeg/png/gif/zip/hwp/ppt/pptx/doc/pdf/xlsx/txt만 가능합니다");
			}
			else if(ext3 != 'jpg' && ext3 != 'png' &&ext3 != 'gif' &&ext3 != 'zip' &&ext3 != 'hwp' &&ext3 != 'ppt' &&ext3 != 'pptx' &&ext3 != 'jpeg' &&ext3 != 'doc' &&ext3 != 'pdf' &&ext3 != 'xlsx'&&ext3 != 'txt'){
				alert("업로드 가능한 파일은 jpg/jpeg/png/gif/zip/hwp/ppt/pptx/doc/pdf/xlsx/txt만 가능합니다");
			}
			else {
				myform.submit();
