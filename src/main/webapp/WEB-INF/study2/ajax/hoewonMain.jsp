		...
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="button" id="join" value="회원등록" onclick="hInput()" class="btn btn-success mr-2"/>
					...
					<input type="button" value="전체보기" onclick="location.href='hoewonList.st';" class="btn btn-secondary mr-2"/>
				</td>
			</tr>
		</table>
	</form>
