...
<div class="container">
	...
	<form name="myform" method="post" action="BoardInputOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>글제목</th>
				<td><input type="text" name="title" id="title" placeholder="제목을 입력하세요." class="form-control" required autofocus /></td>
			</tr>
			<tr>
				<th>글 내용</th>
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="submit" value="글 올리기" class="btn btn-primary mr-2" />
