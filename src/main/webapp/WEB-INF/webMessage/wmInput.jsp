...
<head>
  ...
  <script>
    ...
    function idSearchCheck() {
    	...
    	location.href = "IdSearchCheck.wm?mid="+mid;
    }
  </script>
</head>
<body>
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <td colspan="2" class="text-center">
          ...
          <input type="button" value="다시쓰기" class="btn btn-primary mr-2" onclick="location.href='WebMessage.wm?mSw=0';"/>
          <input type="button" value="돌아가기" onclick="location.href='WebMessage.wm?mSw=1';" class="btn btn-warning"/>
        </td>
      </tr>
    </table>
  </form>
